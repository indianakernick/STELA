...
sym::Func *lookupDup(const sym::Table &, sym::Name, const sym::FuncParams &);
...
sym::Func *lookupCall(const sym::Scope &, sym::Name, const sym::FuncParams &, Log &);
/// Find a function with compatable parameter types in the current scope. Used
/// for finding functions inside structs
sym::Func *lookupMemCall(const sym::Table &, sym::Name, const sym::FuncParams &, Log &);
...
sym::Symbol *lookupDup(const sym::Table &, sym::Name);
