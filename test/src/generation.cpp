...
TEST_GROUP(Generation, {
  ...
  TEST(Lambda conversion to bool, {
    ASSERT_SUCCEEDS(R"(
      extern func passed() {
  ...
  TEST(Loops, {
    ...
    ASSERT_EQ(breaks(-6), 0);
    ASSERT_EQ(breaks(-5), 0);
    ASSERT_EQ(breaks(-4), 0);
    ASSERT_EQ(breaks(-3), 0);
    ASSERT_EQ(breaks(-2), 0);
    ASSERT_EQ(breaks(-1), 0);
    ASSERT_EQ(breaks(0), 0);
    ASSERT_EQ(breaks(1), 1);
    ASSERT_EQ(breaks(2), 3);
    ASSERT_EQ(breaks(3), 12);
    ASSERT_EQ(breaks(4), 12);
    ASSERT_EQ(breaks(5), 12);
    ASSERT_EQ(breaks(6), 12);
    
    auto continues = GET_FUNC("continues", Sint(Sint));
    
    ASSERT_EQ(continues(-6), 1);
    ASSERT_EQ(continues(-5), 1);
    ASSERT_EQ(continues(-4), 1);
    ASSERT_EQ(continues(-3), 1);
    ASSERT_EQ(continues(-2), 1);
    ASSERT_EQ(continues(-1), 1);
    ASSERT_EQ(continues(0), 1);
    ASSERT_EQ(continues(1), 1);
    ASSERT_EQ(continues(2), 2);
    ASSERT_EQ(continues(3), 6);
    ASSERT_EQ(continues(4), 9);
